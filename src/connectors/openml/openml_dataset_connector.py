...
from database.models import DataDownload
from database.models import DatasetDescription, Keyword, License
...
class OpenMlDatasetConnector(DatasetConnector):
    def fetch(self, node_specific_identifier: str) -> DatasetDescription:
        ...
        return DatasetDescription(
            ...
            same_as=dataset_json["original_data_url"],
            ...
            keywords=[Keyword(name=tag) for tag in set(dataset_json["tag"])],
            license=License(name=dataset_json["licence"]),
