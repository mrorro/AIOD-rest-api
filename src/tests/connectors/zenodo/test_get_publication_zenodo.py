...
#         identifier=1,
#         title="Student-Centred Studio Environments: A Deep Dive into Architecture Students' Needs", # noqa
...
#     assert response.status_code == 404
#     assert (
#         response.json()["detail"] == "Error while fetching data from Zenodo: 'PID does not exist.'"  # noqa
#     )
#
#
