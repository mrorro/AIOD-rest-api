...
class ComputationalResourceTypeEnumLink(SQLModel, table=True):  # type: ignore [call-arg]
    ...
    type: str = Field(max_length=1500, schema_extra={"example": "The type of service according to a namespace-based classification (the namespace MAY be related to a middleware name, an organization or other concepts; org.ogf.glue is reserved for the OGF GLUE Working Group)"})
