...
#
#     statusInfo: str = Field(
#         max_length=1500,
#         schema_extra={
#             "example": "Web page providing additional information like monitoring aspects"
#         },
#     )
#
#     statusInfo_identifier: int = Field(foreign_key="statusInfo.identifier", primary_key=True)
#     statusInfo_enum_identifier: int = Field(
#         foreign_key="statusInfo_enum.identifier", primary_key=True
#     )
