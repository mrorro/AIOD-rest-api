...
class OrmProject(OrmAIResource):
    ...
    total_cost_euro: Mapped[float] = mapped_column(Numeric(12, 2), nullable=True, default=None)
    eu_contribution_euro: Mapped[float] = mapped_column(Numeric(12, 2), nullable=True, default=None)
